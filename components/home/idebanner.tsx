...
export default function ProjectCardMinimal() {
  return (
    <div className="mx-auto w-full max-w-4xl overflow-hidden rounded-xl bg-white shadow-md dark:bg-gray-900">
          ...
          <div className="flex h-full flex-col justify-between">
            <div>
              ...
              <p className="mb-6 text-sm leading-relaxed text-gray-600 dark:text-gray-300">
                E-commerce inspirado en VS Code para programadores. Encuentra productos exclusivos
                relacionados con tus lenguajes de programación y tecnologías favoritas.
              </p>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between border-t border-gray-100 pt-6 dark:border-gray-800">
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center rounded-md border border-gray-200 bg-transparent px-4 py-2 text-sm font-medium text-gray-900 transition-colors hover:bg-gray-100 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800"
                >
