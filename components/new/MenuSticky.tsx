      ...
      {isVisible && (
        ...
        >
          ...
          <motion.ul
            ...
            } mt-2 flex-col space-y-2 rounded-lg  bg-neutral-900 bg-opacity-80 p-4 text-white shadow-lg backdrop-blur-md md:mt-0 md:flex md:flex-row md:space-x-1 md:space-y-0`}
          >
            {menuItems.map((item) => {
